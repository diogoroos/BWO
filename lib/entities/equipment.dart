...
class Equipment implements OnAnimationEnd {
  ...
  void loadSprite(String spriteFolder) async {
    ...
    equipmentWalk = SpriteController(
        "equipment/weapons/$spriteFolder/walk", _viewPort, _pivot, _scale, Offset(4, 1), framesCount, this);
    equipmentAttack = SpriteController(
        "equipment/weapons/$spriteFolder/attack", _viewPort, _pivot, _scale, Offset(5, 1), framesCount, this);
