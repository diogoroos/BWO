...
abstract class Entity extends PhysicsEntity {
  ...
  void _drawShadown(Canvas c) {
    ...
    shadownLarge?.render(
      c,
      position:
          Vector2(x - sizeX * distanceToGround + shadownOffset.dx, y - sizeY * distanceToGround + shadownOffset.dy),
      size: Vector2.all(SpriteController.spriteSize * shadownSize * distanceToGround),
      overridePaint: p,
    );
  }
