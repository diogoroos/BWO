...
class Enemy extends Entity implements OnAnimationEnd {
  ...
  Enemy(double x, double y, this.map, this.spriteFolder, String myId) : super(x, y) {
  ...
  void draw(Canvas c) {
    ...
    if (currentSprite != null) {
      ...
      currentSprite.draw(c, x, y, xSpeed, ySpeed, animSpeed, mapHeight, stopAnimWhenIdle: stopAnimWhenIdle);
    }
    //debugDraw(c);
    TextPaint(style: TextStyle(fontSize: 11.0, color: Colors.white, fontFamily: "Blocktopia"))
  ...
  void _loadSprites(spriteFolder) {
    ...
    walkSprites = SpriteController("$spriteFolder/walk", _viewPort, _pivot, _scale, _gradeSize, framesCount, this);
    attackSprites = SpriteController("$spriteFolder/attack", _viewPort, _pivot, _scale, _gradeSize, framesCount, this);
